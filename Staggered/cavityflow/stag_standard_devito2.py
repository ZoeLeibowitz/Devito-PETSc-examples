...
eq_v = Eq(v.dt + u*v.dxc + v*v.dyc,
          -1./rho * p.dy + nu*(v.dx2 + v.dy2))
...
pyplot.xlabel('X')
pyplot.ylabel('Y')
pyplot.savefig('stag_cavity_flow_devito2.png', dpi=100, bbox_inches='tight')
pyplot.show()
...
ax1.set_xlabel('$x$')
ax1.set_ylabel('$v$')
pyplot.savefig('stag_cavity_flow_devito_comparison2.png', dpi=100, bbox_inches='tight')
pyplot.show()
