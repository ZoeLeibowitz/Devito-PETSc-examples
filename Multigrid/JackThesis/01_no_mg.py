...
for n in n_values:
    ...
    iters = summary.petsc[('section0', 'helmholtz_1d')].KSPGetIterationNumber
...
plt.legend()
plt.tight_layout()
plt.savefig("convergence_no_mg.png", dpi=200)
plt.show()
...
plt.title('KSP Iterations vs. Problem Size (no preconditioner)')
plt.grid(True, which='both', ls='--')
plt.tight_layout()
plt.savefig("iters_vs_n_no_mg.png", dpi=200)
plt.show()
