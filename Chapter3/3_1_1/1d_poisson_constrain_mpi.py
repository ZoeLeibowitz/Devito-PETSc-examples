...
# this is why the plot is slightly different compared to the 1d_poisson_mpi.py file - which starts at n=9
...
if comm.rank == 0:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"3_1_1_constrain_mpi_procs{size}.png", dpi=200, metadata={})
    plt.show()
