...
pyplot.grid(False)
pyplot.plot(X, phi.data[0], color='blue',linestyle='-', marker='o', markersize=3, linewidth=2, label=f'BTCS at $t={0*dt:.2f}$')
pyplot.plot(X, phi.data[4], color='red',linestyle='-', marker='o', markersize=3, linewidth=2, label=f'BTCS at $t={4*dt:.2f}$')
pyplot.plot(X, phi.data[9], color='orange',linestyle='-', marker='o', markersize=3, linewidth=2, label=f'BTCS at $t={9*dt:.2f}$')
pyplot.plot(X, phi.data[14], color='green',linestyle='-', marker='o', markersize=3, linewidth=2, label=f'BTCS at $t={14*dt:.2f}$')
pyplot.plot(X, phi.data[19], color='brown',linestyle='-', marker='o', markersize=3, linewidth=2, label=f'BTCS at $t={19*dt:.2f}$')
