...
# DEVITO_MPI=1 mpiexec -n 4 python3 poisson_collatz_mpi.py -ksp_converged_reason -ksp_type cg -ksp_rtol 1e-12 -pc_type none
...
# after this, well defo at 513, the round off error starts to dominate
...
if comm.rank == 0:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"3_1_8_mpi_procs{size}.png", dpi=200, metadata={})
