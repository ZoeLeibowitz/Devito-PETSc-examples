...
# python3 4thorder.py -ksp_converged_reason -ksp_type gmres -ksp_rtol 1e-12 -pc_type none
...
plt.legend()
plt.tight_layout()
plt.savefig("3_1_2_forced_4thorder.png", dpi=200)
plt.show()
